...
public class Fri3Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fri3);

        DownloadTask task = new DownloadTask();
        String result = null;

        try {
            result = task.execute("http://hackarizona.org/techtalks.json").get();
        }
    ...
    private void setUpListView() {
        ...
        scheduleView = (ListView) findViewById(R.id.fri3_list);

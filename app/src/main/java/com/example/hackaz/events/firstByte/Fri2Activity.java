...
public class Fri2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            result = task.execute("http://hackarizona.org/firstbyte.json").get();
        }
    ...
    private void setUpListView() {
        ...
        scheduleView = (ListView) findViewById(R.id.fri2_list);
